...
/// Territory growth scaling exponent (produces ~1.6x-1.8x growth per 2x territory)
...
// --- MACRO-PHASES & PACING ---
/// Playable neutral area percentage threshold to initiate FINAL_FRONTIER transition (2% to 5%)
pub const EXPANSION_ERA_NEUTRAL_THRESHOLD: f64 = 0.035; // 3.5%
/// Maximum duration of Expansion Era before the frontier era naturally draws to a close (seconds)
pub const EXPANSION_ERA_MAX_SECONDS: f32 = 120.0; // 2 minutes (2400 ticks @ 20Hz)
...
pub const COMBAT_BASE_CASUALTY_RATE: f64 = 0.015;
